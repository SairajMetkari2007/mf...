class Form {
    ...
    display(){
      ...
      this.text.position(displayWidth/2-200,displayHeight/2+30)
      this.text2.html("2.Press 'K' key to Kick");
      this.text2.position(displayWidth/2-200,displayHeight/2+30+30)
      this.text3.html("3.Press 'A' key to move Left");
      this.text3.position(displayWidth/2-200,displayHeight/2+60+30)
      this.text4.html("4.Press 'D' key to move Right");
      this.text4.position(displayWidth/2-200,displayHeight/2+90+30)
      this.text5.html("5. If your fighter dissapear on the edges just move to the opposite directions of the egdes");
      this.text5.position(displayWidth/2-200,displayHeight/2+120+30)
      this.text6.html("6. Its a multiplayer game play it with your friends");
      this.text6.position(displayWidth/2-200,displayHeight/2+150+30)
      this.text7.html("7. You can punch or kick the other player only if you are touching him");
      this.text7.position(displayWidth/2-200,displayHeight/2+180+30)
